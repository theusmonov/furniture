import {
    ...
    deleteCategoryById,
    getAllCategories,
    getCategoryById, updateCategoryBy
...
const GetCategoryById = async (req, res, next) => {
    try{
        const dataById = await getCategoryById(req.params.uuid);
...
const UpdateCategory = async (req, res, next) => {
    try {
        const data = await updateCategoryBy(req.params.uuid, req.body, req);
...
const DeleteCategoryById = async (req, res, next) => {
    try {
        const dataDelById = await deleteCategoryById(req.params.uuid);
...
export {AddCategory, DeleteAllCategory, DeleteCategoryById, GetAllCategory, GetCategoryById, UpdateCategory};